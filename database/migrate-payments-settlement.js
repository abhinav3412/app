...
async function migrate() {
  try {
    // 1. Payments table - tracks all payment events
    ...
    // 2. Settlements table - tracks splits between fuel station, worker, platform
    ...
    // 4. Service request settlement tracking
    ...
    // 5. Platform configuration for fees and surge
    ...
    // 6. Initialize platform settings if not exists
    ...
    console.log("\n✅ Migration complete!");
    console.log("New tables: payments, settlements, platform_settings");
    console.log("Updated tables: workers (configuration), service_requests (settlement tracking)");
  } catch (err) {
